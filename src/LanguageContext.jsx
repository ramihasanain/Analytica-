...
export const translations = {
  ar: {
    ...
    authGoogleConnecting: "جاري التحقق من حساب Google...",
    authGoogleWait: "يرجى الانتظار...",
    authGoogleError: "فشل تسجيل الدخول عبر Google",
    authGoogleNoCode: "لم يتم استلام رمز التفويض من Google.",
    authGoogleFail: "تعذّر إكمال تسجيل الدخول عبر Google.",
    authGoogleNotConfigured: "تسجيل الدخول عبر Google غير مُعدّ بعد.",
    authTotpSetupTitle: "تفعيل Google Authenticator",
    authTotpSetupSub: "امسح رمز QR لربط حسابك — مطلوب لمرة واحدة فقط.",
    authTotpVerifyTitle: "رمز التحقق",
    authTotpVerifySub: "أدخل الرمز المكوّن من 6 أرقام من تطبيق Google Authenticator.",
    ...
    authTotpExistingNote: "المستخدمون الحاليون: عند أول دخول بعد هذا التحديث، يجب إعداد Google Authenticator.",
  ...
  en: {
    ...
    authGoogleConnecting: "Verifying your Google account...",
    authGoogleWait: "Please wait...",
    authGoogleError: "Google sign-in failed",
    authGoogleNoCode: "No authorization code received from Google.",
    authGoogleFail: "Could not complete Google sign-in.",
    authGoogleNotConfigured: "Google sign-in is not configured yet.",
    authTotpSetupTitle: "Set up Google Authenticator",
    authTotpSetupSub: "Scan the QR code to link your account — one-time setup.",
    authTotpVerifyTitle: "Verification code",
    authTotpVerifySub: "Enter the 6-digit code from Google Authenticator.",
    ...
    authTotpExistingNote: "Existing users: on your first login after this update, you must set up Google Authenticator.",
