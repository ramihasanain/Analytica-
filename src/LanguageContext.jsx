...
export const translations = {
  ar: {
    ...
    authTotpSetupTitle: "تفعيل التحقق الثنائي",
    authTotpSetupSub: "امسح رمز QR بتطبيق المصادقة — مطلوب لمرة واحدة فقط.",
    authTotpVerifyTitle: "رمز التحقق",
    authTotpVerifySub: "أدخل الرمز المكوّن من 6 أرقام من تطبيق المصادقة.",
    authTotpScanHint: "افتح Google Authenticator → إضافة حساب → مسح QR",
    authTotpManualKey: "المفتاح اليدوي",
    authTotpCode: "رمز التحقق (6 أرقام)",
    authTotpActivate: "تفعيل والدخول",
    authTotpBack: "العودة لتسجيل الدخول",
    authTotpRequired: "يرجى إدخال رمز التحقق.",
    authTotpInvalid: "رمز التحقق غير صحيح.",
    authTotpExistingNote: "المستخدمون الحاليون: عند أول دخول بعد هذا التحديث، يجب إعداد التحقق الثنائي.",
    ...
    ovChartSubEmpty: "لا توجد بيانات مزامنة بعد لعرضها على المحور الزمني",
    ovChartPosts: "منشورات",
    ovChartComments: "تعليقات",
    ovEngChartTitle: "التفاعل على المنشورات عبر الزمن",
    ovEngChartEmpty: "لا توجد بيانات تفاعل (إعجابات / مشاركات) بعد",
    ovEngChartLikes: "إعجابات",
    ovEngChartShares: "مشاركات",
    ovEngChartInteractions: "إجمالي التفاعل",
    ovEngKpiLikes: "إجمالي الإعجابات",
    ovEngKpiShares: "إجمالي المشاركات",
    ovEngKpiInteractions: "إجمالي التفاعلات",
    ...
    postsShowDetails: "عرض التعليقات",
  ...
  en: {
    ...
    authTotpSetupTitle: "Set up two-factor authentication",
    authTotpSetupSub: "Scan the QR code with your authenticator app — one-time setup.",
    authTotpVerifyTitle: "Verification code",
    authTotpVerifySub: "Enter the 6-digit code from your authenticator app.",
    authTotpScanHint: "Open Google Authenticator → Add account → Scan QR",
    authTotpManualKey: "Manual key",
    authTotpCode: "Verification code (6 digits)",
    authTotpActivate: "Activate & sign in",
    authTotpBack: "Back to sign in",
    authTotpRequired: "Please enter your verification code.",
    authTotpInvalid: "Invalid verification code.",
    authTotpExistingNote: "Existing users: on your first login after this update, you must set up two-factor authentication.",
    ...
    ovChartSubEmpty: "No synced data yet to show on the timeline",
    ovChartPosts: "Posts",
    ovChartComments: "Comments",
    ovEngChartTitle: "Post engagement over time",
    ovEngChartEmpty: "No engagement data (likes / shares) yet",
    ovEngChartLikes: "Likes",
    ovEngChartShares: "Shares",
    ovEngChartInteractions: "Total interactions",
    ovEngKpiLikes: "Total likes",
    ovEngKpiShares: "Total shares",
    ovEngKpiInteractions: "Total interactions",
    ...
    postsShowDetails: "View comments",
