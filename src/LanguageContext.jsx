...
export const translations = {
  ar: {
    ...
    sentSubtitle: "تقرير عاطفي عميق ومحدث بالخلفية لـ {count} منشوراً وتعليقاً مسحوباً.",
    ...
    sentTotalTexts: "إجمالي النصوص",
    sentSarcasmRate: "نسبة التهكم",
    sentCsat: "مؤشر رضا العملاء",
    sentNps: "صافي الترويج",
  ...
  en: {
    ...
    sentSubtitle: "Deep, live emotional report for {count} synced posts and comments.",
    ...
    sentTotalTexts: "Total texts",
    sentSarcasmRate: "Sarcasm rate",
    sentCsat: "Customer satisfaction",
    sentNps: "Net promoter score",
